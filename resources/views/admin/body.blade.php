											...
											<div class="tab-pane fade show active" id="Daily" role="tabpanel">
												<div class="d-flex flex-wrap align-items-center px-4 bg-light">
													...
													<ul class="users pl-3 py-2">
														<li><img src="{{asset('assets')}}/admin/images/users/1.png" alt=""></li>
														<li><img src="{{asset('assets')}}/admin/images/users/2.png" alt=""></li>
														<li><img src="{{asset('assets')}}/admin/images/users/3.png" alt=""></li>
														<li><img src="{{asset('assets')}}/admin/images/users/4.png" alt=""></li>
														<li><img src="{{asset('assets')}}/admin/images/users/5.png" alt=""></li>
													</ul>
												</div>
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										<ul class="users-sm mb-3">
											<li><img src="{{asset('assets')}}/admin/images/users/6.png" alt=""></li>
											<li><img src="{{asset('assets')}}/admin/images/users/7.png" alt=""></li>
											<li><img src="{{asset('assets')}}/admin/images/users/8.png" alt=""></li>
											<li><img src="{{asset('assets')}}/admin/images/users/9.png" alt=""></li>
											<li><img src="{{asset('assets')}}/admin/images/users/10.png" alt=""></li>
										</ul>
										<div class="d-flex align-items-center">
									...
									<div class="card-body">
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{asset('assets')}}/admin/images/users/1.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{asset('assets')}}/admin/images/users/2.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{asset('assets')}}/admin/images/users/3.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{asset('assets')}}/admin/images/users/4.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{asset('assets')}}/admin/images/users/5.jpg" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
											...
											<table class="table table-responsive-sm">
												<tbody>
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/6.jpg" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/7.jpg" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/8.jpg" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/9.jpg" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/10.jpg" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{asset('assets')}}/admin/images/users/11.jpg" alt="" class="img-2 mr-3">
																<div>
