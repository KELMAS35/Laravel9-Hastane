                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                            ...
                            <div class="dashboard_bar">
								<div class="input-group search-area d-lg-inline-flex d-none">
									...
									<div class="input-group-append">
										<span class="input-group-text"><a href="{{asset('assets')}}/adminjavascript:void(0)"><i class="flaticon-381-search-2"></i></a></span>
									</div>
								</div>
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="{{asset('assets')}}/adminjavascript:void(0)" role="button" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('assets')}}/admin/{{asset('assets')}}/admin/images/avatar/1.jpg">
													</div>
                                    ...
                                    <a class="all-notification" href="{{asset('assets')}}/adminjavascript:void(0)">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="{{asset('assets')}}/adminjavascript:void(0)">
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="{{asset('assets')}}/adminjavascript:void(0)" role="button" data-toggle="dropdown">
									<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div id="DZ_W_TimeLine1" class="widget-timeline dz-scroll style-1 height370">
										<ul class="timeline">
											<li>
												...
												<a class="timeline-panel text-muted" href="{{asset('assets')}}/admin#">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{asset('assets')}}/admin./app-profile.html" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="{{asset('assets')}}/admin./email-inbox.html" class="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ml-2">Inbox </span>
                                    </a>
                                    <a href="{{asset('assets')}}/admin./page-login.html" class="dropdown-item ai-icon">
